...
| V6-1 | ✅ 完成 | 職業系統 + 20 技能（劍士/弓手/法師/聖騎士）|
| V6-2 | ✅ 完成 | 技能升階系統 + CharacterView 重構 |
| V6-3 | ✅ 完成 | 地下城即時戰鬥播放（ATB 動畫 / CD 面板）|
| V6-4 | ✅ 完成 | 高等內容：成就系統 / 菁英戰鬥 / 天賦樹 |
| V7-1 | ✅ 完成 | 採集系統擴充（4 NPC × 16 地點）|
| V7-3 | ✅ 完成 | 廚師 NPC + 料理系統 |
| V7-4 | ✅ 完成 | 農夫 / 消耗品 / 製藥師 + 商人更新 |
| V8-1 | ✅ 完成 | 裝備稀有度擴充 |
...
9. **新功能前主動提問**：收到新功能需求時，先針對不確定的設計決策、邊界條件、依賴關係提出問題，確認後再開始實作。問題應聚焦在「會影響實作方向的選擇」，而非細節措辭。
