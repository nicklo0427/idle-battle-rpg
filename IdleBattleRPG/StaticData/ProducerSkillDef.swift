...
extension ProducerSkillNodeDef {
    ...
    static let all: [ProducerSkillNodeDef] = [
        ...
        .init(key: "bs_mastery", actorKey: "blacksmith",
              name: "爐火純青",
              description: "每點提升精良及以上武器 5% 屬性", maxLevel: 3,
              prerequisiteKey: "bs_gold", prerequisiteLevel: 1,
              effect: .qualityBonus(0.05)),

        // MARK: 鍛造學徒（weaponsmith）
        .init(key: "ws_speed", actorKey: "weaponsmith",
              name: "副手快工",
              description: "每點縮短 5% 副手製作時間", maxLevel: 3,
              effect: .durationReduction(0.05)),
        .init(key: "ws_gold", actorKey: "weaponsmith",
              name: "省料議價",
              description: "每點降低 10% 副手製作金幣消耗", maxLevel: 2,
              prerequisiteKey: "ws_speed", prerequisiteLevel: 1,
              effect: .goldCostReduction(0.10)),
        .init(key: "ws_mastery", actorKey: "weaponsmith",
              name: "副手精工",
              description: "每點提升精良及以上副手 5% 屬性", maxLevel: 3,
              prerequisiteKey: "ws_gold", prerequisiteLevel: 1,
              effect: .qualityBonus(0.05)),

        // MARK: 裁縫師（tailor）
        .init(key: "ta_speed", actorKey: "tailor",
              name: "快針密縫",
              description: "每點縮短 5% 防具製作時間", maxLevel: 3,
              effect: .durationReduction(0.05)),
        .init(key: "ta_gold", actorKey: "tailor",
              name: "省材裁剪",
              description: "每點降低 10% 防具製作金幣消耗", maxLevel: 2,
              prerequisiteKey: "ta_speed", prerequisiteLevel: 1,
              effect: .goldCostReduction(0.10)),
        .init(key: "ta_mastery", actorKey: "tailor",
              name: "量身精製",
              description: "每點提升精良及以上防具 5% 屬性", maxLevel: 3,
              prerequisiteKey: "ta_gold", prerequisiteLevel: 1,
              effect: .qualityBonus(0.05)),

        // MARK: 飾品師（jeweler）
        .init(key: "jw_speed", actorKey: "jeweler",
              name: "快速鑲嵌",
              description: "每點縮短 5% 飾品製作時間", maxLevel: 3,
              effect: .durationReduction(0.05)),
        .init(key: "jw_gold", actorKey: "jeweler",
              name: "精準估價",
              description: "每點降低 10% 飾品製作金幣消耗", maxLevel: 2,
              prerequisiteKey: "jw_speed", prerequisiteLevel: 1,
              effect: .goldCostReduction(0.10)),
        .init(key: "jw_mastery", actorKey: "jeweler",
              name: "寶石共鳴",
              description: "每點提升精良及以上飾品 5% 屬性", maxLevel: 3,
              prerequisiteKey: "jw_gold", prerequisiteLevel: 1,
              effect: .qualityBonus(0.05)),
